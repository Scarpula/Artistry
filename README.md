<p>$\huge{\rm{\color{#F6F5F2}Artistry}}$</p>

<p>$\huge{\rm{\color{#F6F5F2}프로젝트 소개}}$</p>
...
<p>$\huge{\rm{\color{#F6F5F2}기술 스택}}$</p>
...
<p>$\huge{\rm{\color{#F6F5F2}사용 방법}}$</p>

<p>$\huge{\rm{\color{#F6F5F2}주요 기능}}$</p>
...
<p>$\huge{\rm{\color{#F6F5F2}라이센스}}$</p>

이 프로젝트는 [MIT 라이선스](LICENSE) 하에 제공됩니다.

<p>$\huge{\rm{\color{#F6F5F2}문의}}$</p>
