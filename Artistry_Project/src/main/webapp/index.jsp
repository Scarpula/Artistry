              ...
              <div class="access-gird-holder _01">
                <div class="access-gird">
                  <div class="access-card">
                    <div style="-webkit-transform:translate3d(65px, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(-55deg) rotateZ(0) skew(0, 0);-moz-transform:translate3d(65px, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(-55deg) rotateZ(0) skew(0, 0);-ms-transform:translate3d(65px, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(-55deg) rotateZ(0) skew(0, 0);transform:translate3d(65px, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(-55deg) rotateZ(0) skew(0, 0);opacity:0;transform-style:preserve-3d" class="access-small-image-holder"><img src="images/Main-page--1_2.JPG" loading="lazy" sizes="(max-width: 1279px) 57vw, (max-width: 1439px) 718.1221923828125px, (max-width: 1919px) 50vw, 10vw" srcset="images/Main-page--1_2-p-500.jpg 500w, images/Main-page--1_2-p-800.jpg 800w, images/Main-page--1_2-p-1080.jpg 1080w, images/Main-page--1_2.JPG 1252w" alt="" class="access-small-image"></div>
