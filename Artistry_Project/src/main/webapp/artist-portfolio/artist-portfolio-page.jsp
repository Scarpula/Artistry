...
<html data-wf-page="660fa367cce1a421bb169fcb"
							...
							<div class="form-search-wrap">
								<div class="form-search-container w-form">
									<form id="wf-form-Search-Form" name="wf-form-Search-Form"
										...
										class="form-search" data-wf-page-id="660fa367cce1a421bb169fcb"
		...
		<div class="portfolio-container">
			...
			<div class="main-container">
				<div
					...
					class="portfolio-profile-tab">
					<div class="portfolio-profile-img-wrap">
						<img src="../images/11.png" loading="lazy"
							sizes="(max-width: 1279px) 100vw, (max-width: 1919px) 1024.0078125px, 4vw"
					...
					<div class="profile-button">
						<a data-w-id="99207502-0852-453a-11ee-a5ad15b0abad" href="#"
							class="request-button w-button">의뢰하기</a> <a href="#"
							class="follow-button w-button">1 : 1 채팅</a> <a
							href="artistry-portfolio-setting-page.jsp"
							class="follow-button setting-button w-button">포트폴리오 수정하기</a>
					</div>
					<div class="like-container">
						<img src="../images/Like_lofo-removebg.png" loading="lazy"
							...
							sizes="(max-width: 767px) 100vw, (max-width: 1919px) 511.9921875px, 127.9921875px"
							class="like-img">
				...
				<div class="container-wrap">
					<div class="portfolio-tab">
						<div class="portfolio-tab-container">
							<a data-w-id="3c63d0a9-d188-a90e-6059-a31e3e83735e" href="#"
								class="portfolio-tab-link-block w-inline-block">
								<div>포트폴리오</div>
							</a> <a data-w-id="f8257c14-e0ef-be89-1a8b-5e65d4d9ad8d" href="#"
								class="portfolio-tab-link-block w-inline-block">
								<div>아티스트 정보</div>
							</a> <a data-w-id="07b1a153-89b1-8e59-80a4-bf6c4a05d952" href="#"
								class="portfolio-tab-link-block w-inline-block">
								<div>리뷰</div>
							</a>
						</div>
					...
					<div
						...
						<div class="w-layout-grid artist-art-grid">
							...
							%>
							<div id="w-node-_550a96a2-a744-3681-3a62-95b4ca1c003a-bb169fcb"
								class="artist-art-form">
								<div data-w-id="1cbd1ca6-35dd-5037-fb9c-405a15f6cf3f"
									class="artist-art">
									<img src="<%=portList.get(i).getPf_Path()%>" loading="lazy"
										width="350" height="252" alt=""
										sizes="(max-width: 479px) 100vw, (max-width: 1919px) 349.9921875px, 242.8828125px"
										class="artist-art-img">
								</div>
					...
					<div id="Artist-infomation" style="display: none"
						class="portfolio-artist-infomation">
						<h1 class="portfolio-artist-infomation-title">
							<strong class="bold-text">15년 이상의 브랜드 전문가와 함께 하세요~</strong>
						</h1>
						<p class="portfolio-artist-infomation-text">
							디자이너 gutta 공모전 수상 경력 사항<br> <br>‍<br>Hi 서울 웹포스터
							공모전 [수상 : 대상]09년 수산물 브랜드 대전 [수상 : 은상]<br>‍<br>제8회대한민국비쥬얼트랜드대전
							[수상 : 특선]<br>제3회 Blue Leage 포트폴리오 대전 [수상 : 입선]<br>07년
							Edtool 표지디자인 공모전 [수상 : 입상]<br>08년 UNICORN증보시스템 캐릭터 공모전 [수상 :
							2위]<br>제44회 대한민국 디자인 전람회 [수상 : 입선]<br>10년 춘천월드레져총회 및
							경기대회 캐릭터 공모전 [수상 : 입선]<br>14년 순천만 정원포스터 공모전 [수상 : 동상]<br>16년
							담양대나무축제 포스터 [수상:대상]<br>‍<br> <br>(자격사항)웹디자인 기능사
							취득그래픽운용기능사 취득교원(실기교사) 자격증 취득브랜드컨설턴트 수료
						</p>
						<div class="information-stats">
							<h1 class="heading-7">판매량</h1>
							<div class="sales-volume">
								<img src="../images/shopping_bag_FILL0_wght400_GRAD0_opsz24.svg"
									loading="lazy" width="48" height="48" alt="" class="image-9">
								<h1>73</h1>
							</div>
						</div>
					...
					<div style="display: none" class="portfolio-artist-review">
						...
						<div class="review-writing-block w-form">
							...
							if (loginMember != null) {
							%>
							<form action="../ReviewService" method="post" id="email-form"
								class="review-writing-form"
								data-wf-page-id="660fa367cce1a421bb169fcb"
								data-wf-element-id="de265365-044b-c91d-7432-08d6c918aa7e">
								<label for="field" class="field-label-4">리뷰 작성하기</label>

								<!-- <input type="hidden" name="mb_Email" value=" loginMember.get">  -->

								<div class="review-text-area-wrapp">
									<textarea name="content"
										placeholder="작품을 잘 받아보셨다면, 솔직한 후기를 남겨주세요^^" maxlength="5000"
										id="field" name="field" data-name="Field"
										class="review-text-area w-input"></textarea>
									<div class="value-submit-wrap">
										<h3>별점을 선택해주세요</h3>
										<select name="ratings" id="field-2" data-name="Field 2"
										...
										</select> <input type="submit" class="submit-button-3 w-button"
											value="리뷰작성 완료">
									</div>
								</div>
							</form>
						...
						<div class="w-layout-grid review-container">
							<div id="w-node-_8616ec42-16ad-8146-6b61-c251d1221daa-bb169fcb"
								class="review-block">
								...
								<div class="review-text-up">
									...
									%>
									<img src="../images/star.svg" loading="lazy" width="50"
										height="37" alt="" class="review-star">
									<%
									}
									%>
				...
				<div class="request-form-wrap">
					...
					<div data-w-id="f1f0f9e6-8eea-6be6-da34-9748990e277c"
						...
						<div class="file-upload preview-image">
							<label for="input-image">파일 선택</label> <input type="file"
								id="input-image" class="upload-hidden">
						</div>
					</div>
				</div>
				<div class="request-form-wrap-2">
					...
					<div class="frame-price-form-block w-form">
						<form id="email-form-2" name="email-form-2"
							data-name="Email Form 2" method="post"
							data-wf-page-id="660fa367cce1a421bb169fcb"
							data-wf-element-id="2dfbc100-32b3-76a9-dec3-d9e147758136">
							<label class="w-checkbox frame-choose"><input
								type="checkbox" name="" data-name=""
								class="w-checkbox-input checkbox-3"><span
								class="checkbox-label-2 w-form-label">액자 추가</span></label>
							<div class="radio-wrap">
								<label class="frame-choose-radio w-radio"><input
									type="radio" data-name="frame price" id="30-000"
									name="frame-price" required=""
									class="w-form-formradioinput price-button w-radio-input"
									value="30,000"><span
									class="radio-button-label w-form-label" for="30-000">30,000원</span></label><label
									class="frame-choose-radio w-radio"><input type="radio"
									data-name="frame price" id="50-000" name="frame-price"
									required=""
									class="w-form-formradioinput price-button w-radio-input"
									value="50,000"><span
									class="radio-button-label-2 w-form-label" for="50-000">50,000원</span></label><label
									class="frame-choose-radio w-radio"><input type="radio"
									data-name="frame price" id="70-000" name="frame-price"
									required=""
									class="w-form-formradioinput price-button w-radio-input"
									value="70,000"><span
									class="radio-button-label-3 w-form-label" for="70-000">70,000원</span></label><label
									class="frame-choose-radio w-radio"><input type="radio"
									data-name="frame price" id="100-000" name="frame-price"
									required=""
									class="w-form-formradioinput price-button w-radio-input"
									value="100,000"><span
									class="radio-button-label-4 w-form-label" for="100-000">100,000원</span></label>
							</div>
						</form>
						<div class="w-form-done">
							<div>Thank you! Your submission has been received!</div>
					...
					<div class="choose-modification w-form">
						<form id="email-form-2" name="email-form-2"
							...
							<label class="w-checkbox frame-choose"><input
								type="checkbox" name="" data-name=""
								class="w-checkbox-input checkbox-3"><span
								class="checkbox-label-2 w-form-label">추가 수정횟수(30,000원/회)</span></label>
							<div class="radio-wrap">
								<label class="frame-choose-radio w-radio"><input
									type="radio" data-name="frame price" id="30-000"
									name="frame-price" required=""
									class="w-form-formradioinput price-button w-radio-input"
									value="30,000"><span
									class="radio-button-label w-form-label" for="30-000">1회</span></label><label
									class="frame-choose-radio w-radio"><input type="radio"
									data-name="frame price" id="50-000" name="frame-price"
									required=""
									class="w-form-formradioinput price-button w-radio-input"
									value="50,000"><span
									class="radio-button-label-2 w-form-label" for="50-000">2회</span></label><label
									class="frame-choose-radio w-radio"><input type="radio"
									data-name="frame price" id="70-000" name="frame-price"
									required=""
									class="w-form-formradioinput price-button w-radio-input"
									value="70,000"><span
									class="radio-button-label-3 w-form-label" for="70-000">3회</span></label><label
									class="frame-choose-radio w-radio"><input type="radio"
									data-name="frame price" id="100-000" name="frame-price"
									required=""
									class="w-form-formradioinput price-button w-radio-input"
									value="100,000"><span
									class="radio-button-label-4 w-form-label" for="100-000">4회</span></label><label
									class="frame-choose-radio w-radio"><input type="radio"
									data-name="frame price" id="30-000" name="frame-price"
									required=""
									class="w-form-formradioinput price-button w-radio-input"
									value="30,000"><span
									class="radio-button-label w-form-label" for="30-000">5회</span></label>
							</div>
						</form>
						<div class="w-form-done">
							<div>Thank you! Your submission has been received!</div>
				...
				<div class="request-form-wrap-3">
					...
					<div class="request-text-area w-form">
						<form id="email-form-3" name="email-form-3"
							data-name="Email Form 3" method="post" class="text-area-form"
							data-wf-page-id="660fa367cce1a421bb169fcb"
							data-wf-element-id="b4d1ec42-6ae0-b4d9-64f8-2ff74e9f71d7">
							<textarea placeholder="" maxlength="5000" id="Request-Text"
								name="Request-Text" data-name="Request Text"
