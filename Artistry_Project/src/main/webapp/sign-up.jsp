				...
				<li class="nav-item">
					<div data-hover="false" data-delay="0"
						...
						<nav class="navbar-dropdown-list w-dropdown-list">
							...
							<a href="sign-up.jsp" aria-current="page"
					...
					<div class="artistry-login-form w-form">
						...
						<form action="signup-second-form.jsp" method="post"
							...
							<input name="mb_Birthdate" class="text-field-2 w-input"
								maxlength="256" data-name="Birthdate"
								placeholder="'20240124'의 형식으로 입력 해 주세요." type="date" required="">
							...
							<div class="email-check-form">
								<input name="mb_Addr" class="text-field w-input" maxlength="256"
