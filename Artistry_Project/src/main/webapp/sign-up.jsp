...
<html data-wf-page="65fd1577d3de0c8242fadc9e"
        ...
        <li class="nav-item">
          <div data-hover="false" data-delay="0" class="navbar-dropdown w-dropdown">
            ...
            <nav class="navbar-dropdown-list w-dropdown-list">
              ...
              <a href="sign-up.html" aria-current="page" class="navbar-dropdown-link w-dropdown-link w--current">회원가입</a><button class="navbar-dropdown-link bottom" data-wf-user-logout="로그아웃" data-wf-user-login="회원가입" type="button">로그아웃</button>
            </nav>
          </div>
        </li>
      </ul>
      ...
      <div class="signup-form-block">
         <div
            ...
            <div class="artistry-banner">
               <h1 class="artistry-head-text signuppage">Artistry</h1>
            </div>
           ...
           <!--회원가입 Form 시작-->
            ...
            <form action="signup-second-form.jsp" method="post" id="email-form">
                     ...
                     <input name="mb_Birthdate" class="text-field-2 w-input"
                        maxlength="256" data-name="Birthdate" placeholder="'20240124'의 형식으로 입력 해 주세요." type="date"
                        required="">


                     <div class="form-text">전화번호</div>
                     <input name="mb_Phone" class="text-field-2 w-input"
                        maxlength="256" data-name="Email 2"
                        placeholder="'-'없이 숫자만 입력해주세요" type="tel" required="">
                     <div class="boundary signup-form _02"></div>


                     <div class="form-text">닉네임</div>
                     <input name="mb_Nick" class="text-field-2 w-input"
                        maxlength="256" data-name="nick" placeholder="" type="text"
                        id="nick" required="">
               ...
               <!-- 우편번호 검색 API 구현하기 -->
                     ...
                     <div class="email-check-form">
                        ...
                        <input id="AddrCheck" type="button"
               ...
               <!-- 우편번호 검색 API 구현끝 -->
                     ...
                     <div class="submit-form-wrap">
                        <input type="reset" class="sign-up-button w-button" value="취소"> 
