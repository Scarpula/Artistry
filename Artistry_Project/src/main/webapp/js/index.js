...
const avatarhtml = function(message) {
	...
	profileImage.src = message.profileImageUrl || window.loginMemberProfileUrl;
	...
	function setupUsernameInputEventListener() {
		// login anonymously
		client.loginAnonymous({ userId: generateRandomId(), username: loginMemberNick, profileImageUrl: loginMemberProfileUrl }, function(errResp, data) {
